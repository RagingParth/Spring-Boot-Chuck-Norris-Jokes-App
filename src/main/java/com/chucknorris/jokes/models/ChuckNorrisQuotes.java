...
public class ChuckNorrisQuotes
{
    ...
    public ChuckNorrisQuotes()
    {
        ...
        this.quotes.add("Chuck Norris does infinite loops in 4 seconds.");
        ...
        this.quotes.add("Count from one to ten. That's how long it would take Chuck Norris to kill you...Forty seven times.");
        ...
        this.quotes.add("Chuck Norris doesn't wear a watch, HE decides what time it is.");
        ...
        this.quotes.add("Chuck Norris once kicked a horse in the chin. Its descendants are known today as Giraffes.");
